...
<#
	...
	.PARAMETER Destination
		...
		Не обязательный параметр. По умолчанию (если параметр не указан) результат распологается рядом с папкой сканирования.
	.PARAMETER Delimiter
...
#$Host.EnterNestedPrompt() 
	...
	# с подавлениее сообщений об ошибках с возобновлением выполнения  (-ErrorAction SilentlyContinue)
	#
	# | 
...
#>
	...
	[int]$Lines = 0
	$reader = New-Object IO.StreamReader $FullFileName
